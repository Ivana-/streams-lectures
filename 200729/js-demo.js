...
// print("f_loop: ", f_loop(40000))
// print("f__rec: ", f__rec(40000))
// print("f_trec: ", f_trec(40000, 0))

const is_even = (n) => n==0 ? true : is_odd(n-1)  // tail call case
const is_odd = (n) => n==0 ? false : is_even(n-1) // tail call case

// print("is_even: ", is_even(40000))
...
// print("Init: ", show(a))
// print("mapN: ", show(mapN(inc, b)))
// print("mapT: ", show(mapT(inc, b)))
// print("mapL: ", show(mapL(inc, b)))
...
// print("ccN: ", ccN(50000, coins)) // 100, 10000, 50000
print("ccC: ", ccC(50000, coins)) // 100, 10000, 50000, 100000
// print("ccA: ", ccA(200, coins)) // 100, 10000
